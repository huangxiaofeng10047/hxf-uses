---
description: docker buildx 是docker的扩展插件
slug: buildx
public: true
title: docker buildx学习
createdAt: 1718852258921
updatedAt: 1718854092290
tags: []
...
![clipboard2.png](/posts/buildx_clipboard2-png.png)
#### builder
...
![enter image description here](https://learn.lianglianglee.com/%E6%96%87%E7%AB%A0/assets/7141ec30-830d-11e9-8eb9-49b38b06f9d6.jpg)
...
![clipboard.png](/posts/buildx_clipboard-png.png)
...
![enter image description here](https://learn.lianglianglee.com/%E6%96%87%E7%AB%A0/assets/2f5601d0-830d-11e9-a8d7-c164a8393e9a.jpg)
...
```bash
remote/spring-boot              1                              1fd0923bfc95   19 seconds ago   121MB
```
...
这里发现我们的镜像并没有减小，这是因为WARNING: experimental flag squash is removed with BuildKit. You should squash inside build using a multi-stage Dockerfile for efficiency.
这句话的含义是多层构建可以减小大小。
...
参考文档：
https://github.com/docker/buildx/tree/v0.15.1